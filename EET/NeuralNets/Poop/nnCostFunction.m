...
start2 = end1 + 1;
end2 = start2 + hidden_layer_size * (hidden_layer_size + 1) - 1;
start3 = end2 + 1;

Theta1 = reshape(nn_params(1:end1), ...
                 hidden_layer_size, (input_layer_size + 1));
                 
Theta2 = reshape(nn_params(start2:end2), ...
                 hidden_layer_size, (hidden_layer_size + 1));

Theta3 = reshape(nn_params(start3:end), ...
...
h_theta = sigmoid(Theta3 * a2'); % h_theta equals z3
...
for t=1:m,
    ...
    a3 = sigmoid(z3); % final activation layer a4 == h(theta)
    ...
    delta_2 = (Theta3' * delta_3) .* sigmoidGradient(z2);
    ...
    Theta3_grad = Theta3_grad + delta_3 * a2';
    Theta2_grad = Theta2_grad + delta_2 * a1';
    Theta1_grad = Theta1_grad + delta_1 * a0; % I don't know why a1 doesn't need to be transpost (brute force try)
